...
const CatScreens = () => {
  return (
    <Stack.Navigator
      initialRouteName="NearestEvents"
      ...
      />
      <Stack.Screen
        name="JazzcashCardDetailScreen"
        component={JazzcashCardDetailScreen}
      />
    </Stack.Navigator>
  );
};
  ...
  OrganizerTabStack() {
    return (
      <Tab.Navigator
        ...
        tabBar={props => <OrganizerCustomTab {...props} />}
        screenOptions={{headerShown: false}}>
