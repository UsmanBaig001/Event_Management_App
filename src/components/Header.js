...
export default function Header({ leftArrow, navigation, rightEdit, onEditPress, rightAddIcon, addEvent, title }) {
    ...
    return (
        <View style={{ width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between", height: 100, backgroundColor: colors.orange, paddingTop: 15 }} >
            ...
            <View style={{ position: "absolute", width: "100%", alignItems: "center", paddingTop: 15 }} >
                {
                    title &&
                    <LatoText text={title || "SIGN UP"} color={colors.white} fontName={font.semibold} fontSize={25} />
                }
            </View>
            <View style={{ paddingRight: 20 }} >
                <View style={{ flexDirection: "row", alignItems: "center" }} >
                    {
                        rightAddIcon &&
                        <TouchableOpacity onPress={() => addEvent()} style={{ marginRight: 0 }} >
