        ...
        <TouchableOpacity {...{ onPress }} style={[styles.tabContainerShadow, { width: "90%", height: 247, backgroundColor: "white", borderRadius: 30, alignSelf: "center", marginTop: 20 }]} >
            ...
            <View style={{ width: "100%", height: 172, }} >
                <View style={{ width: "100%", height: 172, justifyContent: "center", alignItems: "center" }} >
                    <Image style={{ width: "100%", height: "100%", borderTopLeftRadius: 30, borderTopRightRadius: 30 }} source={item?.featureImage ? { uri: item?.featureImage } : LOCATION_IMG} resizeMode="stretch" />
            ...
            <View style={{ flex: 1, backgroundColor: "#F6F6F6", borderBottomLeftRadius: 30, borderBottomRightRadius: 30, justifyContent: "center", paddingHorizontal: 20 }} >
                <LatoText text={item ? item?.name : "THE CASTLE ROAD"} fontSize={15} fontName={font.medium} />
                <LatoText text={item ? item.tagLine : "Romantic trail of castles"} fontSize={15} fontName={font.light} />
            </View>
        </TouchableOpacity>
    )
}
